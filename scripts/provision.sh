...
csi() {
  ...
  {
    echo "csi:"
    echo "  csiRBDProvisionerResource: |"
    ...
    echo "        limits:"
    echo "          memory: 100Mi"
    echo "    - name : csi-rbdplugin"
    echo "      resource:"
    echo "        requests:"
    echo "          memory: 50Mi"
    echo "        limits:"
    echo "          memory: 100Mi"
    echo "    - name : csi-omap-generator"
    echo "      resource:"
    echo "        requests:"
    echo "          memory: 50Mi"
    echo "          cpu: 250m"
    ...
    echo "        limits:"
    echo "          memory: 200Mi"
    echo "  csiRBDPluginResource: |"
    echo "    - name : driver-registrar"
    echo "      resource:"
    echo "        requests:"
    echo "          memory: 100Mi"
    echo "          cpu: 50m"
    ...
    echo "        limits:"
    echo "          memory: 200Mi"
    echo "  csiCephFSProvisionerResource: |"
    echo "    - name : csi-provisioner"
    echo "      resource:"
    echo "        requests:"
    echo "          memory: 100Mi"
    ...
    echo "        limits:"
    echo "          memory: 200Mi"
    echo "  csiNFSProvisionerResource: |"
    echo "    - name : csi-provisioner"
    echo "      resource:"
    echo "        requests:"
    echo "          memory: 100Mi"
